    ...
    <div className="bg-[#F4F7FA] min-h-[calc(100vh-64px)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-extrabold text-[#0B1B3D]">Welcome Back</h2>
          <p className="mt-2 text-sm text-gray-600">
            Sign in to your Naukri Passport account
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-xl overflow-hidden">
          <div className="bg-gradient-to-r from-[#002D62] to-[#0A58CA] p-6 text-center">
            <h3 className="text-white font-bold tracking-wide">SECURE LOGIN PORTAL</h3>
          </div>
            ...
            <form className="space-y-6">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label className="block text-sm font-bold text-[#0B1B3D]">Password</label>
                  <Link href="#" className="text-sm font-bold text-[#0A58CA] hover:text-blue-800">
                    Forgot password?
                  </Link>
                </div>
                <div className="relative">
          ...
          <div className="px-8 py-6 bg-gray-50 border-t border-gray-100 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/register" className="font-bold text-[#0A58CA] hover:text-blue-800 transition-colors">
                Create Profile Now
              </Link>
            </p>
          </div>
